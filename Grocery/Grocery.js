...
function Grocery(){
    ...
    const [hover, setHover] = useState(null);
      ...
      return(
       ...
       :
        <>
        <h1 id='bn' className='text-center my-4'>Grocery's</h1>
  
  
          <input type='text' className="form-control mx-5" onChange={(e)=>{setnavbar(e.target.value)}} placeholder="SEARCH YOUR GROCERY'S "/>
