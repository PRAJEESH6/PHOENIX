import './Home1.css';
import biryani from '../imgs/comp1.png';
       ...
       <div className='Container' id='body'>
        <div className='row'>
            ...
            <h4 id='main11a'>Phoenix Shopper's Delight </h4>
              ...
              <h5 id='det11a'>In the intricate tapestry of our modern world, computers emerge as the silent architects of progress, tirelessly processing data and executing commands. </h5>
            ...
            <div className="col-6">
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" id='mer1a'>
                ...
                <img src={biryani} alt='pic' id='bir1i'/>
                </div>
            </div>
        </div>
