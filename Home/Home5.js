import './Home1.css';
import biryani from '../imgs/w.png';
...
function Home5(){
    return(
        ...
        <div className='Container' id='body'>
            <div className='row'>
                <div className='col-6'>
                <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" id='mer15'>
                ...
                <img src={biryani} alt='pic' id='bir6'/>
                </div>
              ...
              <h5 id='det11a'>Watches, once solely instruments of timekeeping, have transformed into timeless accessories that marry functionality with elegance and Masterpiece.</h5>
