...
function Camera(){
  ...
  const [hover, setHover] = useState(null);
    ...
    return(
       ...
       :
        <>
       <h1 className="text-center my-4" id="bn" >Camera's</h1>

        <input type='text' className="form-control mx-5" onChange={(e)=>{setnavbar(e.target.value)}} placeholder="Search your Crystel Clear Camera's"/>
