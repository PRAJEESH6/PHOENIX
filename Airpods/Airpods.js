...
import { useEffect, useState,useCart } from 'react';
      ...
      return(
       ...
       :
        <>
          ...
          <input type='text' className="form-control" placeholder="SEARCH YOUR FAV AIRPODS" onChange={(e)=>{setnavbar(e.target.value)}}/>
